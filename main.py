...
st.write("Note: This data primarily focuses on apps utilizing the Rewards Pool for B3TR distribution. This data only includes information up to September 21, 2024")
